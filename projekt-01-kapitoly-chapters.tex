...
\begin{figure}[hbt]
	...
	\boldcaption[Dear ImGui.]{ Demostrační aplikace představující knihovnu \texttt{Dear ImGui}. Na obrázku jsou vidět různé komponenty, které lze využít pro tvorbu uživatelského rozhraní.}
